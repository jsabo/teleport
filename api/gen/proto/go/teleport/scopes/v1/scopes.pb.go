...
// while agent certificates are kind AGENT. The pin kind determines wether the privileges associated with an identity are
...
type Pin struct {
	...
	// kind indicates the pin kind (USER or AGENT). Pin kind determines wether this identity's privileges are conveyed
...
const file_teleport_scopes_v1_scopes_proto_rawDesc = "" +
	...
	"\fsystem_roles\x18\x05 \x01(\v2\x1f.teleport.scopes.v1.SystemRolesR\vsystemRoles\"\xfa\x01\n" +
