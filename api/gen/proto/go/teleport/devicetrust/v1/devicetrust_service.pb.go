...
type SyncInventoryStart struct {
	...
	// os_types optionally declares the OS types this sync covers.
	// When non-empty:
	//   - track_missing_devices only reports devices whose os_type is in this
	//     list
	//   - upserts and removals whose os_type is not in this list are rejected
	//     with a per-device error
	//
