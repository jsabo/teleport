...
<Resources
  title="Get started configuring Teleport"
  secondaryTitle=""
  description="Read these guides first if you are new to configuring Teleport."
  ...
  resources={[
    {
      title: "Configure a Teleport cluster",
      description: "Learn how the static configuration file works in a demo self-hosted cluster running Teleport Community Edition.",
      iconComponent: teleportSvg,
      href: "../get-started/deploy-community/",
    },
    {
      title: "Configure the Teleport SSH Service",
      description: "Learn how to configure the Teleport SSH Service to protect a Linux server with Teleport.",
      iconComponent: linuxServersSvg,
      href: "../enroll-resources/server-access/getting-started/"
    },
    {
      title: "Manage Teleport users and roles",
      description: "Users and roles are the foundation of Teleport access controls. Learn how to manage them with Infrastructure as Code tools.",
...
<Resources
  title="Learn more about static configuration"
  secondaryTitle=""
...
<Resources
  title="Learn more about dynamic configuration"
  secondaryTitle=""
...
<Resources
  title="Manage dynamic resources"
  ...
  resources={[
   {
    ...
    },
    {
      ...
      iconComponent: bookOpenSvg,
      href: "../reference/static-and-dynamic-configuration/",
    }
  ]}
/>
