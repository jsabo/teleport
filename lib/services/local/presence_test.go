...
func TestGetDatabaseServersByDatabaseName(t *testing.T) {
	...
	t.Run("ParameterValidation", func(t *testing.T) {
		_, err = iterstream.Collect(presence.GetDatabaseServersByDatabaseName(ctx, ""))
		require.ErrorAs(t, err, new(*trace.BadParameterError))
	})
	...
	t.Run("MultipleServersSameDatabase", func(t *testing.T) {
		servers, err := iterstream.Collect(presence.GetDatabaseServersByDatabaseName(ctx, "shared-db"))
		require.NoError(t, err)
	...
	t.Run("SingleServerForDatabase", func(t *testing.T) {
		servers, err := iterstream.Collect(presence.GetDatabaseServersByDatabaseName(ctx, "standalone-db"))
		require.NoError(t, err)
	...
	t.Run("NoServersForDatabase", func(t *testing.T) {
		servers, err := iterstream.Collect(presence.GetDatabaseServersByDatabaseName(ctx, "nonexistent-db"))
		require.NoError(t, err)
